...
export const HOST_ZONE_OVERRIDE_NEAR_METERS = 5;
export const HOST_ZONE_OVERRIDE_MIN_DWELL_SECONDS = 10;
export const HOST_ZONE_OVERRIDE_MIN_RTK_DISTANCE_METERS = 40;
